...
void main() {
  testWidgets('lists organisation accounts with their status and location',
      (tester) async {
  ...
  testWidgets(
      'entering a search term and picking an organisation type/city, then Apply Filters, passes them through',
      (tester) async {
    final repo = _FakeAdminOrganisationsRepository([_item()]);
    await _pump(tester, repo);
        ...
        child: MaterialApp(
          ...
          onGenerateRoute: (settings) {
            ...
            return MaterialPageRoute(
                builder: (_) =>
                    const Scaffold(body: Text('Organisation Detail Screen')));
          },
        ),
      ),
    );
