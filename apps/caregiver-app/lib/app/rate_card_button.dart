...
class RateCardButton extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // budget) with a hand-built Row so the icon-label gap can shrink to 2px
    // — shares AppBar space with WhatsApp help and Logout, same reasoning
    // as WhatsAppHelpButton's own compact styling. Wrapped in a right-margin
    // Padding so it never sits flush against a neighboring button or the
    // screen edge.
    return Padding(
