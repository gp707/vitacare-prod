...
class RateCardButton extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Compact constraints/padding — shares AppBar space with other actions
    // (Job Search Preferences, WhatsApp help, Logout), same reasoning as
    // WhatsAppHelpButton's own compact styling.
    return IconButton(
